...
# System dependencies
echo "Installing system dependencies..."
sudo apt install -y mpg123 python3-venv python3-pip portaudio19-dev python3-pyaudio libasound2-dev zstd espeak ffmpeg
...
echo "source .venv/bin/activate && ollama serve > /dev/null 2>&1 & python3 voris.py"
    echo "Creating virtual environment..."
    python3 -m venv .venv
fi
